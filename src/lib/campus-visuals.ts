...
const CAMPUS_VISUALS: CampusVisualConfig[] = [
  {
    label: "Calicut",
    assetPath: "/Calicut - campus copy.png",
    accent: "#0F766E",
    aliases: ["calicut", "kozhikode"],
  },
  {
    label: "Kannur",
    assetPath: "/Kannur-Campus.png",
    accent: "#1D4ED8",
    aliases: ["kannur"],
  },
  {
    label: "Kottayam",
    assetPath: "/Kottayam Campus.png",
    accent: "#7C3AED",
    aliases: ["kottayam"],
  },
  {
    label: "Perinthalmanna",
    assetPath: "/Perinthalmanna-Campus copy.png",
    accent: "#BE123C",
    aliases: ["perinthalmanna", "perithalmanna", "malappuram", "malapuram"],
  },
  {
    label: "Thrissur",
    assetPath: "/Thrissur - Campus copy.png",
    accent: "#B45309",
    aliases: ["thrissur"],
  },
  {
    label: "Trivandrum",
    assetPath: "/Trivandrum Campus copy.png",
    accent: "#0F172A",
    aliases: ["trivandrum", "thiruvananthapuram"],
  },
  {
    label: "Kochi - Vyttila",
    assetPath: "/Vytilla Campus copy.png",
    accent: "#155E75",
